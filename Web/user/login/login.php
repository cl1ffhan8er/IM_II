<html lang = "en">
    ...
    <div class="carousel-section">
        <div class="carousel-wrapper">
            ...
            <div class="carousel-slide" style="background-image: url('../images/bg5.jpg');"></div>
            <div class="carousel-slide" style="background-image: url('../images/bg6.jpg');"></div>
            <div class="carousel-slide" style="background-image: url('../images/bg7.jpg');"></div>
            </div>
        </div>
    </div>
