...
<nav class="navbar">
  ...
  <main class="help-content">
    ...
    <div class="faq-box">
      ...
      <ul>
        <li>Visit the Home Page and click the “Book Now” button.</li>
        <li>Choose a travel type: custom or regular packages.</li>
        <li>Provide the necessary trip information (pickup time, dropoff time, number of passengers, and other relevant info).</li>
        <li>Choose your payment method (online or pay on-site).</li>
        <li>You’ll receive a confirmation number and email once your order is processed.</li>
      </ul>

      <h3>2. Can I customize my itinerary?</h3>
      <p>Yes! In the Home page, there is a designated button meant to direct you to the custom itinerary page, where you can freely design and coordinate your stops, destinations, and schedules. 
        Making a custom itinerary comes with a downpayment of <b>500 PESOS</b>, and the final payment will be calculated based on gasoline consumption, driver’s fee, and maintenance fee for the van. 
        Lastly, our team will reach out to you to confirm the plan’s feasibility and availability.
      </p>
