...
<div class="page-wrapper"><!-- ✅ Page wrapper start -->
    ...
    <main class="success-container">
        ...
        <br>
        <p>Your booking is currently marked as <strong>PENDING</strong>.</p>
        ...
        <a href="../index.php" style="display:inline-block; margin-top:30px; text-decoration:none; font-weight:bold; font-size:1.1rem; color:#0b7890;">
            ← Return to Home
        </a>
    </main>
